            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-sitemap"></i> Logging Info</span></a></li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
...
?>
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          <li><a href="add_vehicle.php">Add New Users Vehicle</a>
                          </li>
                          <li><a href="display_vehicle.php">Display Users Vehicle</a>
                          </li>
                        </ul>
                      </li>
      ...
      <!-- register new user form -->
                    <form action="php_action/admin_register_vehicle.php" method="POST" class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="vehicle_model">Vehicle Model <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="plat_num">Vehicle Plat Number<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="plat_num" name="plat_num" class="form-control col-md-7 col-xs-12" >
                        </div>
                      </div> 
