...
<form action="php_action/admin_edit_vehicle_action.php" method="post" class="form-horizontal form-label-left" novalidate>
 ...
 <div class="item form-group">
  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="user_ic">User IC Number<span class="required">*</span></label>
    <div class="col-md-6 col-sm-6 col-xs-12">
       <input type="text" id="user_ic" name="user_ic" value="<?php echo $user_ic; ?>" required class="form-control col-md-7 col-xs-12" readonly>
         </div>
         </div>
