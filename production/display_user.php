                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                         <li><a href="add_user.php">Add New User</a> </li>
                          <li><a href="display_user.php">Display New Users</a></li>
                        </ul>
                      </li>
                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Users Address</th>
                          <th>Users Email Address</th>
                          <th>Users Password</th>
                          <th>Users Serial Number</th>
                          <th>Update</th>
                          <th>Remove</th>
                        </tr>
                      </thead>
...
<?php
if(isset($_GET['del'])){
$del_user_ic = $_GET['del'];
if(mysqli_query("Delete from user where user_ic = '$del_user_ic'")){
echo "<script>alert('User of IC Number : $del_user_ic are deleted successful!')</script>";
...
$run = mysqli_query($con, "SELECT user.user_name, user.user_ic, user.user_phone, user.user_address, user.user_email, user.user_pass, card.serial_num FROM user, card WHERE user.user_ic = card.user_ic");
...
<td><a href='admin_edit_user.php?edit=$showuser_ic'>Update</td>
<td><a href='display_user.php?del=$showuser_ic'>Remove</td>
</tr>";
}
?>
