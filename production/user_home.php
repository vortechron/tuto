        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"></a> <!-- company -->
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="user_home.php"><i class="fa fa-home"></i> Home</span></a></li>
                  <li><a href="user_vehicle.php"><i class="fa fa-automobile"></i> Vehicle's Info</span></a></li>
                  <li><a href="user_timestamp.php"><i class="fa fa-desktop"></i> Logging's Info</span></a> </li>
                </ul>
              </div>
            </div>
            <!-- /sidebar menu -->
